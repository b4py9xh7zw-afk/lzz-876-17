...
5. 成绩统计：个人成绩与管理端统计数据。
6. 成绩申诉复核：学生对分数、判题或异常标记发起申诉（选择题目、填写原因、上传证据）；老师复核可维持、加分、减分或转给教务；成绩单展示复核完成状态，后台保留每个处理人的意见轨迹。

## 角色权限
| 角色 | 可访问模块 |
|---|---|
| Student | 在线考试、我的成绩（含提交申诉、查看复核轨迹） |
| Teacher | 在线考试、我的成绩、题库管理、试卷管理、申诉复核 |
| Admin | 全部功能（含数据统计、教务终审申诉） |
...
## 数据库说明
当前初始化后包含 12 张核心表（含用户、题目、试卷、考试记录、答案记录、成绩申诉、申诉复核轨迹等）。
